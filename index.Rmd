...
Increased cost of capture and file size leading to increased storage and prcoessing costs.
...
Individual trees are clearly visible and when zooming in vehicles are also identifiable demostrating the power of the sensor.
...
This helped to really highlight where vegetation is (yellows and greens) against the more urban areas (blue).  Smaller trees are now also idenitfiable that weren't clearly visible in the RGB image.
